...
1. 2D vessel segmentation from DSA images.
2. Vessel skeleton extraction and topology construction.
3. Hierarchical 2D/3D vessel matching.
4. Projective-prior-weighted pose optimization.
5. 3D vascular guidance based on the calibrated 2D/3D mapping relationship.
