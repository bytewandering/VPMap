...
if __name__ == "__main__":
    ...
    dir_path = "F:/backup/data/IAS/IAS_2D_3D_Registration/using"
    ...
    for i in range(0,len(dir_list)):
        ...
        # w0 = np.array([-np.pi/2,0,0,10,10,10])
        ...
        """读取sag影像"""
        #读取影像数据
        dsa2d_seg_sag_path = data_dir+"\\seg_sag.nii.gz"
        ...
        """输出投影图像"""
        """修改配准方法需要修改的地方3/3"""
        out_put_dir = "F:/backup/data/IAS_train_info/IAS_2D_3D_Registration/norm_data/ICP_PWO/9/"
